    ...
    :UBAbstractSubPalette(orient, parent)
{
    ...
    //Alpha button
    UBActionPaletteButton* btnAlphaColor = new UBActionPaletteButton(shapeActions->actionColorStyleTransparent, this);
    ...
    // ColorType buttons
    UBActionPaletteButton* btnFullColor = new UBActionPaletteButton(shapeActions->actionColorStyleFull, this);
    btnFullColor->setStyleSheet(styleSheetLeftGroupedButton);
    colorStyleLayout->addWidget(btnFullColor);
    shapeActions->actionColorStyleFull->setChecked(true);

    UBActionPaletteButton* btnFillStyleDense = new UBActionPaletteButton(shapeActions->actionFillStyleDense, this);
    btnFillStyleDense->setStyleSheet(styleSheetCenterGroupedButton);
    colorStyleLayout->addWidget(btnFillStyleDense);

    UBActionPaletteButton* btnFillStyleDiag = new UBActionPaletteButton(shapeActions->actionFillStyleDiag, this);
    btnFillStyleDiag->setStyleSheet(styleSheetCenterGroupedButton);
    colorStyleLayout->addWidget(btnFillStyleDiag);

    UBActionPaletteButton* btnGradientColor = new UBActionPaletteButton(shapeActions->actionColorStyleGradient, this);
