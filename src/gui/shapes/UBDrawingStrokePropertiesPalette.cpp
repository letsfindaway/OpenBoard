    ...
    :UBAbstractSubPalette(orient, parent)
{
    ...
    UBActionPaletteButton* btnThickness1 = new UBActionPaletteButton(shapeActions->actionStrokePropertyThickness0, this);
    ...
    shapeActions->actionStrokePropertyThickness0->setChecked(true);

    UBActionPaletteButton* btnThickness2 = new UBActionPaletteButton(shapeActions->actionStrokePropertyThickness1, this);
    ...
    UBActionPaletteButton* btnThickness3 = new UBActionPaletteButton(shapeActions->actionStrokePropertyThickness2, this);
    ...
    // Style buttons
    UBActionPaletteButton* btnSolidLine = new UBActionPaletteButton(shapeActions->actionStrokePropertyStyleSolidLine, this);
    ...
    shapeActions->actionStrokePropertyStyleSolidLine->setChecked(true);

    UBActionPaletteButton* btnDotLine = new UBActionPaletteButton(shapeActions->actionStrokePropertyStyleDotLine, this);
    ...
    UBActionPaletteButton* btnCustomDash = new UBActionPaletteButton(shapeActions->actionStrokePropertyStyleCustomDash, this);
