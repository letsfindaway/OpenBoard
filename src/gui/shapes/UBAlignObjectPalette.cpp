    ...
    :UBAbstractSubPalette(orient, parent)
{
    ...
    UBActionPaletteButton *btnAlignToLeft = new UBActionPaletteButton(shapeActions->actionAlignToLeft, this);
    UBActionPaletteButton *btnAlignVerticalCenter = new UBActionPaletteButton(shapeActions->actionVerticalCenter, this);
    UBActionPaletteButton *btnAlignToRight = new UBActionPaletteButton(shapeActions->actionAlignToRight, this);

    UBActionPaletteButton *btnAlignToTop = new UBActionPaletteButton(shapeActions->actionAlignToTop, this);
    UBActionPaletteButton *btnAlignHorizontalCenter = new UBActionPaletteButton(shapeActions->actionHorizontalCenter, this);
    UBActionPaletteButton *btnAlignToBottom = new UBActionPaletteButton(shapeActions->actionAlignToBottom, this);
